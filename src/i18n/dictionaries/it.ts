...
export const it = {
  ...
  margins: {
    ...
    deleteRule: "Elimina",
    enabled: "Attiva",
    generalRule: "Regola generale (tutto il resto)",
    ...
    typeFixed: "Fisso €",
    typeBands: "A fasce di prezzo",
    typeNone: "Nessuno (solo opzioni)",
    percentLabel: "Ricarico %",
    fixedLabel: "Margine €",
    bandUpTo: "Ask fino a €",
    bandInfinity: "oltre",
    bandPercent: "ricarico %",
    bandAdd: "Aggiungi fascia",
    bandRemove: "Togli fascia",
  ...
  repair: {
    title: "Ripara i prodotti sul negozio",
    tag: "non distruttivo",
    ...
    liveTitle: "Riparazione eseguita",
    repaired: (n: number) => `${n} riparati`,
    whole: (n: number) => `${n} già completi`,
    failedCount: (n: number) => `${n} falliti`,
    andMore: (n: number) => `…e altri ${n}`,
    failed: "Riparazione fallita",
    unavailableHint: "Manca sul negozio, ma nemmeno la fonte ce l'ha: non c'è niente da scrivere.",
    fields: { image: "foto", brand: "marchio", category: "categoria", gender: "genere" },
  },
  taxonomy: {
    title: "Tassonomie",
    desc: "Dove finiscono i prodotti sul negozio, e quali campi identità vengono scritti. Ogni modifica viene rieseguita sul catalogo che hai davvero: vedi l'effetto prima di salvare, non dopo aver pubblicato.",
    sourcesTitle: "Chi decide la categoria",
    sourcesHint:
      "Alcune fonti portano una tassonomia curata (KicksDB manda categoria e sotto-categoria come campi veri): quella si può scrivere così com'è. Un listino fornitore non ne porta nessuna — l'albero che vedi a catalogo è dedotto dal titolo, e scriverlo duplicherebbe i Marchi e creerebbe un termine per ogni modello. Per quelle fonti decidono le regole qui sotto.",
    noSources: "Nessun prodotto a catalogo: sincronizza un listino per vedere le fonti.",
    modeTree: "Albero della fonte",
    modeRules: "Regole",
    products: (n: number) => `${n} prodotti`,
    rulesTitle: "Regole di categoria",
    rulesHint:
      "Stesso funzionamento delle regole di margine: la regola più SPECIFICA vince (uno SKU batte un brand, che batte la fonte). Senza nessuna regola che corrisponde vale la categoria predefinita.",
    defaultCategory: "Categoria predefinita",
    defaultPlaceholder: "Sneakers",
    defaultHint:
      "Usa \" > \" per annidare: «Abbigliamento > T-shirt». Lasciala vuota per non scrivere nessuna categoria — il negozio userà la sua predefinita, che è più onesto di un'etichetta inventata.",
    ...
    scopeSource: "Fonte",
    scopeBrand: "Marchio",
    scopeFamily: "Famiglia a catalogo",
    scopeName: "Il nome contiene",
    scopeNamePlaceholder: "hoodie, tee, giacca…",
    scopeSku: "SKU esatto",
    ruleCategory: "Categoria sul negozio",
    ruleCategoryPlaceholder: "Abbigliamento",
    fieldsTitle: "Campi scritti sul negozio",
    fieldsHint:
      "Spegni quello che gestisci altrove: quello che non è spuntato non viene mai scritto, né alla pubblicazione né alla riparazione.",
    writeBrandTaxonomy: "Marchi del prodotto (tassonomia)",
    writeBrandTaxonomyHint: "La tassonomia nativa di WooCommerce — la colonna «Marchi del prodotto».",
    writeBrandAttribute: "Attributo pa_brand",
    writeBrandAttributeHint:
      "Alcuni plugin per Merchant Center / TikTok leggono il marchio solo da qui, non dalla tassonomia.",
    writeGender: "Attributo pa_gender",
    writeGenderHint:
    ...
    save: "Salva",
    saving: "Salvataggio…",
    reset: "Ripristina i valori di partenza",
    upToDate: "Salvato",
    failed: "Operazione fallita",
    appliesHint:
      "Vale per le prossime pubblicazioni. Per i prodotti già online usa «Ripara i prodotti sul negozio» nella scheda Pubblica.",
  },
  publish: {
